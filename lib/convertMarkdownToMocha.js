...
module.exports = function (mdSrc, fileName) {
    ...
    global.sourceMap = sourceMapWithCode.map.toString();
    return (
        ...
        '(' + function () {
            var map = new SourceMapConsumer(global.sourceMap);
